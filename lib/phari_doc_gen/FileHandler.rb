...
module PhariDoc
  class FileHandler
      ...
      def writeCSS(file)
        css_file = PhariDoc::Utils::gem_libdir+'/templates/style.css'
      ...
      def writeProjectPage(project, file, models, description)
        ...
        erb_file = PhariDoc::Utils::gem_libdir+'/templates/project.html.erb'
      ...
      def writeModelPage(file, model, project)
        ...
        erb_file = PhariDoc::Utils::gem_libdir+'/templates/model.html.erb'
        erb_str = File.read(erb_file)
        # renderer = ERB.new(erb_str)
        renderer = Erubis::Eruby.new(erb_str)
        # result = renderer.result_with_hash(variables)
